...
public:
  ...
  double calcular_area() const override { return M_PI * raio * raio; }

  double calcular_perimetro() const override { return 2 * M_PI * raio; }
...
public:
  ...
  double calcular_area() const override { return largura * altura; }

  double calcular_perimetro() const override { return 2 * (largura + altura); }

  void exibir() const override {
    cout << "Retângulo (largura=" << largura << ", altura=" << altura << ")"
         << endl;
    cout << "  Área: " << calcular_area() << endl;
    cout << "  Perímetro: " << calcular_perimetro() << endl;
  }
...
public:
  ...
  double calcular_perimetro() const override { return lado1 + lado2 + lado3; }

  void exibir() const override {
    cout << "Triângulo (lados=" << lado1 << ", " << lado2 << ", " << lado3
         << ")" << endl;
    cout << "  Área: " << calcular_area() << endl;
    cout << "  Perímetro: " << calcular_perimetro() << endl;
  }
